  ...
  return (
    <TooltipProvider>
      <div className="mx-auto w-full max-w-5xl flex flex-col min-h-0">
        <PageSectionHeader
          title={t("files.title", "Saved Files")}
          footer={
        ...
        >
          <span className="text-sm text-muted-foreground">
            {t("files.operationCost", {
              cost: FILE_OPERATION_CREDIT_COST,
            })}
          </span>
        </PageSectionHeader>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      ...
                      >
                        <RemixIcon name="question" size="size-4" />
                      </Button>
                    </TooltipTrigger>
                    <TooltipContent className="max-w-xs text-xs leading-relaxed">
                      <p className="font-medium text-foreground">
                        {t(
                          ...
                          "Add files from your device to store them for later analysis.",
                        )}
                      </p>
                ...
                >
                  <div className="flex flex-col gap-1 text-sm">
                    ...
                    <div className="flex items-center gap-1 text-xs text-muted-foreground">
                      <span>
                        {t("files.storageProviderLabel", "Stored in")}:
                      </span>
